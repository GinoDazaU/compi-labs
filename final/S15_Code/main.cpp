...
int main(int argc, const char* argv[]) {
    ...
    ConstantTaggingVisitor constantTagger;
    constantTagger.tag(program);
    CascadeFunctionEvalVisitor cascadeFunctionEval;
    cascadeFunctionEval.optimize(program);
    SethiUllmanLabelVisitor sethiUllman;
    sethiUllman.label(program);
